<?php /*
 ...
 Description:  Виджет виводит меню категорий в виде аккордеона
  ...
  public $wfm_cats_array;
    ...
    function form($instance) {
      ...
      <p>
       ...
       <p>
      	<label for="<?php echo $this->get_field_id('exclude') ?>">Исключить категории (ID категории через зап'ятую):</label>
      ...
      echo $html;
 		...
 		function wfm_styles_scripts() {
 			...
 			wp_register_script('wfm-accordion', plugins_url('js/jquery.dcjqaccordion.2.7.min.js', __FILE__ ), array('wfm-hoverIntent') );
