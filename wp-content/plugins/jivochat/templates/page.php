...
<div class="wrap">
    ...
    ?>
        ...
        <div class="gray_form">
            ...
            <a  class="button button-primary"  href='<?php if($this->token){ echo JIVO_INTEGRATION_URL.'/login?partnerId=wordpress&token='.$this->token.(JIVO_LANG!='ru'?"&lang=".JIVO_LANG:''); }else{echo 'https://app.jivosite.com';} ?>' target="_blank"><?php _e('Open web version of the app','jivosite'); ?></a>
